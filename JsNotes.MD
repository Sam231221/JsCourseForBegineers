...
4. [Module 4: Data Types Methods](#module-4-data-types-methods)
   ...
   - [Date](#date-methods)
   - [Math](#math-object)
5. [Module 5: DOM Manipulation](#module-5-dom-manipulation)
   - [Selecting Elements](#selecting-elements)
   - [Event Listeners](#event-listeners)
   - [Creating and Modifying Elements](#creating-and-modifying-elements)
6. [Module 6: Asynchronous JavaScript](#module-6-asynchronous-javascript)
   - [Promises](#promises)
   - [Async/Await](#asyncawait)
   - [Fetching Data from APIs](#fetching-data-from-apis)
7. [Module 7: Advanced Topics](#module-7-advanced-topics)
